...
Rails.application.config.assets.precompile += %w( admin/posts.js admin/calendar_posts.js admin/calendar_index.js admin/features_index.js admin/on_court_index.js admin/trend_index.js)
